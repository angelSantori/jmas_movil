...
import 'package:jmas_movil/controllers/salidas_controller.dart';
...
class AddSalidaScreen extends StatefulWidget {
  const AddSalidaScreen({super.key});

  @override
  State<AddSalidaScreen> createState() => _AddSalidaScreenState();
}

class _AddSalidaScreenState extends State<AddSalidaScreen> {
